...
const SecurityConfig = {
    ...
    protections: {
        domainLocking: true,
        antiDebug: false,          // ❌ disable (breaks GH Pages)
        disableRightClick: false,  // optional
        disableShortcuts: false,   // optional
        consoleBlocking: false     // ❌ disable
    },
...
function checkDomainAuthorization() {
    ...
    const allowed = SecurityConfig.authorizedDomains.some(d =>
